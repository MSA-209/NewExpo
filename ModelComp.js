...
const imageSources = {
    ...
    "ChainClevis":[[require('./assets/ChainClevis/ChainClevis_Top.png')],
            ...
            [require('./assets/ChainClevis/ChainClevis_Left_Back_Angle.png'),require('./assets/ChainClevis/ChainClevis_Left.jpg'),require('./assets/ChainClevis/ChainClevis_Left_Angle.png'),require('./assets/ChainClevis/ChainClevis_Center.png'),
            require('./assets/ChainClevis/ChainClevis_Right_Angle.png'),require('./assets/ChainClevis/ChainClevis_Right.jpg'),require('./assets/ChainClevis/ChainClevis_Right_Back_Angle.png'),require('./assets/ChainClevis/ChainClevis_Back.png')],
